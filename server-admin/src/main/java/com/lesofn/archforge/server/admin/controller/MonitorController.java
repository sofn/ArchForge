...
import com.lesofn.archforge.server.admin.dto.request.OnlineLogQuery;
...
public class MonitorController {
    ...
    public AdminPageResult<OnlineUserResponse> getOnlineLogsList(@RequestBody OnlineLogQuery request) {

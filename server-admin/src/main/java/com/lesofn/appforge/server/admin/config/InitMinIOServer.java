...
@Configuration
@Profile("dev")
@ConditionalOnProperty(name = "app-forge.embedded.s3", havingValue = "true")
public class InitMinIOServer {
    ...
    public InitMinIOServer() {
        try {
            ...
            System.setProperty("app-forge.file-storage.type", "s3");
            System.setProperty("app-forge.file-storage.s3.endpoint", endpoint);
            System.setProperty("app-forge.file-storage.s3.access-key", ACCESS_KEY);
            System.setProperty("app-forge.file-storage.s3.secret-key", SECRET_KEY);

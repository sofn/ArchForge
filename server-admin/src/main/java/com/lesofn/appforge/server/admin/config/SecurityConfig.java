...
import com.lesofn.appforge.server.admin.filter.JwtAuthenticationFilter;
import com.lesofn.appforge.server.admin.service.login.AdminUserDetailsService;
...
public class SecurityConfig {
    ...
    public AuthenticationEntryPoint unauthorizedHandler() {
        return (request, response, exception) -> {
            ...
            renderJsonResponse(response, HttpServletResponse.SC_UNAUTHORIZED, ResponseResult.error(AdminAuthErrorCode.USER_AUTHFAIL));
        };
    }
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, CorsFilter corsFilter) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/login", "/register", "/getConfig", "/captchaImage").permitAll()
     ...
     * 渲染JSON响应
     */
    private void renderJsonResponse(HttpServletResponse response, int status, Object data) throws IOException {

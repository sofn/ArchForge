package com.lesofn.appforge.server.admin.util;
...
public class JwtTokenUtil {
    ...
    public JwtTokenUtil(AppForgeConfig appForgeConfig) {
    ...
    private String doGenerateToken(Map<String, Object> claims, String subject) {
        return Jwts.builder()
                ...
                .expiration(new Date(System.currentTimeMillis() + appForgeConfig.getJwt().getExpireSeconds() * 1000))

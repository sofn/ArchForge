...
VALUES
    ('demo-hello', 'DEFAULT', 'Demo: prints hello every 30s', 'demoQuartzJob', 'helloWorld', NULL, '0/30 * * * * ?', 1, 0, 1);
...
VALUES
    (100, '定时任务', 1, 'SystemQuartz', 1, '/system/quartz/index', 0, 'system:quartz:list', '{"title":"定时任务","icon":"ep:timer","showParent":true}', 1, 'Quartz 反射调度任务管理', 0, NOW(), 1, NOW(), 0)

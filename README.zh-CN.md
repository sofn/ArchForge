...
AppForge 是一个**开箱即用的全栈管理系统**，后端基于 Spring Boot 4，前端基于 Vue 3，提供完整的用户/角色/菜单/部门管理、服务器监控、JWT 认证等功能。采用整洁架构，使用现代化技术栈。
...
| 层级 | 技术 |
|------|------|
| 后端 | Java 21, Spring Boot 4.0.5, Spring Security, Spring Data JPA |
| 前端 | Vue 3.5, Vite 8, TypeScript 6, Element Plus, TailwindCSS 4 |
| 数据库 | MySQL 8 (生产), H2 (开发), Redis, Flyway |
| 监控 | Oshi, SpringDoc OpenAPI, Micrometer + OpenTelemetry |
| 构建 | Gradle 9.4.1, pnpm, Docker, GraalVM Native Image |
| 测试 | JUnit 6, Spock 2.4, Testcontainers |

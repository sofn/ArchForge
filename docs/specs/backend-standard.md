...
**Read:** `.agents/skills/archforge-project-standard/standard.md`
([link](../../.agents/skills/archforge-project-standard/standard.md))
...
| `.agents/skills/archforge-project-standard/standard.md` | **Tutorial**: full-stack backend panorama for agents | AI |
...
Keep `standard.md` in the `.agents/skills/` tree so it versions with the code it
describes. This spec **references** it; it does not copy or fork it.

When the backend standard changes, update `.agents/skills/archforge-project-standard/standard.md`.

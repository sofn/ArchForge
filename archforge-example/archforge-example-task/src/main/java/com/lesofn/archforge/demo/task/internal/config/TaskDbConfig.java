package com.lesofn.archforge.demo.task.internal.config;
...
@EnableJpaRepositories(
        basePackages = "com.lesofn.archforge.demo.task.internal.repository",
...
public class TaskDbConfig {
    ...
    LocalContainerEntityManagerFactoryBean taskEntityManagerFactory() {
        ...
        // 此处应包含当前模块的domain类
        factoryBean.setPackagesToScan("com.lesofn.archforge.demo.task.api.domain");

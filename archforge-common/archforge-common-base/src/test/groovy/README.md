# Spock Tests for common-base Module

This directory contains Spock tests for the utility classes in the `common-base` module.
...
```bash
./gradlew :archforge-common:archforge-common-base:test
```
...
These dependencies are already configured in the `common/common-base/build.gradle.kts` file.
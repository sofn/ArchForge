...
import com.lesofn.archforge.meta.table.internal.ddl.AlterDdl;
...
public class MetaTableMigrationService {
    ...
    public List<MetaTableMigration> createPendingRecords(
            MetaTable table, int version, List<AlterDdl> ddlStatements, Long operatorId) {
        List<MetaTableMigration> records = new ArrayList<>();
        LocalDateTime now = LocalDateTime.now();
        for (AlterDdl ddl : ddlStatements) {

...
@EnableJpaRepositories(
        entityManagerFactoryRef = "${entityName?uncap_first}EntityManagerFactory",
        transactionManagerRef = "${entityName?uncap_first}TransactionManager",
...
<#noparse>    @Value("${spring.jpa.hibernate.ddl-auto:none}")</#noparse>
    ...
    @Bean
    PlatformTransactionManager ${entityName?uncap_first}TransactionManager() {
        return new JpaTransactionManager(${entityName?uncap_first}EntityManagerFactory().getObject());
    }
    ...
    LocalContainerEntityManagerFactoryBean ${entityName?uncap_first}EntityManagerFactory() {
        ...
        factoryBean.setPersistenceUnitName("${entityName?uncap_first}");
